...
# accordeons = document.querySelectorAll('[data-type=feats][data-slug]')
# Array.from(accordeons).map(({ dataset }) => dataset.slug)
slugs = [
  "1789092-ability-score-improvement",
  "1789101-alert",
  "1789102-archery",
  "1789109-boon-of-combat-prowess",
  "1789110-boon-of-dimensional-travel",
  "1789112-boon-of-fate",
  "1789114-boon-of-irresistible-offense",
  "1789119-boon-of-the-night-spirit",
  "1789120-boon-of-truesight",
  "1789128-defense",
  "10-grappler",
  "1789148-great-weapon-fighting",
  "1789183-savage-attacker",
  "1789189-skilled",
  "1789207-two-weapon-fighting"
]
