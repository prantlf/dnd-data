...
# accordeons = document.querySelectorAll('.list-row-equipment') 
# Array.from(accordeons).map(({ className }) => className.match(/list-row-equipment-([^ ]+)/)[1])
slugs = [
  "6-abacus",
  "18-acid-vial",
  "19-alchemists-fire-flask",
  "102-alchemists-supplies",
  "284-alexandrite",
  "207-alms-box",
  "247-amber",
  "265-amethyst",
  ...
  "215-arcane-focus",
  "1-arrows",
  "137-assassins-blood-ingested",
  "243-azurite",
  "20-backpack",
  "127-bagpipes",
  "21-ball-bearings-bag-of-1-000",
  "271-banded-agate",
  "170-barding",
  "22-barrel",
  "23-basket",
